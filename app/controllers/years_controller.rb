class YearsController < ApplicationController
  ...
  private
    ...
    def year_params
      params.require(:year).permit(:country_id, :YR2000, :YR2001, :YR2002, :YR2003, :YR2004, :YR2005, :YR2006, :YR2007, :YR2008, :YR2009, :YR2010, :YR2011, :YR2012, :YR2013, :YR2014, :YR2015, :YR2016, :YR2017, :YR2018, :YR2019)
    end
end
